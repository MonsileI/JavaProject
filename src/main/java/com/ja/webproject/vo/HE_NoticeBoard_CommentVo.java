...
public class HE_NoticeBoard_CommentVo {
    ...
    public HE_NoticeBoard_CommentVo() {
		super();
	}

	public HE_NoticeBoard_CommentVo(int comment_no, int member_no, int noticeboard_no, String comment_content,
			Date writeDate) {
		super();
