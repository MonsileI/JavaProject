...
public class HE_NoticeBoard_ImageBoardVo {
    ...
    public HE_NoticeBoard_ImageBoardVo() {
		super();
	}

	public HE_NoticeBoard_ImageBoardVo(int imageboard_no, int noticeboard_no, String imageboard_url,
