...
public class HE_LostdogBoard_CommentVo {
	...
	public HE_LostdogBoard_CommentVo() {
		super();
	}
	public HE_LostdogBoard_CommentVo(int comment_no, int lostdogboard_no, int member_no, String comment_content,
			Date writeDate) {
		super();
