		...
		<div class="row">
			...
			<div class="col-8">
				...
				<form action = "./writeHE_LostDogProcess.do" method="post" enctype="multipart/form-data">
					...
					<!--++++++++++지도test++++++++++++-->
					<div class="mb-3">
						<label for="lostPlace">잃어버린 장소</label> 
			            <input type="text" class="form-control" name="lostPlace" id="lostPlace">  
				    ...
				    geocoder.coord2Address(latlng.getLng(), latlng.getLat() , function(result, status){
				    	...
				    	document.getElementById("lostPlace").value = result[0].address.address_name;
				    }); 
					...
					<div class="mb-3">
						<label for="lostDate">잃어버린 날짜</label> 
					...
					<div class="mb-3">
						...
						<!--  script>
							function selectSpecies(pet){
								pet_no = $("#species_selectList").lost(":selected").val();
								console.log(pet_no);
