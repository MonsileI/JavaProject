	         ...
	         <div class="container-fluid">
	            ...
	            <!--  div  class="container justify-content-center"-->
	               <ul class="navbar-nav" ><!--  navbar-center -->
	                    ...
	                    <li class="nav-item">
	                      <a class="nav-link" href="../lostdogboard/lostdogList.do" style="font-size: 20px;color:#333333 ;">단체소개</a>
	                    </li>
	                    
	                    
	                    
	                      <li class="nav-item">
	                      <a class="nav-link" href="../healingboard/HE_HealingBoardList.do" style="font-size: 20px;color:#333333 ;">힐링공간</a>
	                    </li>
	                  ...
	                  <li class="nav-item dropdown">
	      	           ...
	      	           <li class="nav-item">
	                      <a class="nav-link" href="#" style="font-size: 20px;color:#333333 ;">쇼핑몰</a><!-- href="../shop/index.do -->
	                    </li>
