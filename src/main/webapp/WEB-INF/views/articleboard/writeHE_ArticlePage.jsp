...
<body>
	...
	<form action = "./writeHE_ArticleProcess.do" method="post" enctype="multipart/form-data">
		...
		<div class="mb-3">
		 ...
		 <br>
		 <input class="btn" type="submit" style="margin-top: 10px;background-color:#004ba0;border-color:#004ba0;color:#ffffff" value="저장">
		<!-- <button>저장</button> -->		 
	</form>
